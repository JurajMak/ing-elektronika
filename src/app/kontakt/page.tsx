      ...
      <div className=" col-span-6 p-4 lg:col-start-6 lg:col-span-6 rounded-xl lg:p-0  ">
        ...
        <div className="w-full border-2 rounded-xl  shadow-xl">
          <iframe
            ...
            src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Vinkova%C4%8Dka%20cesta%2021,%2031000,%20Osijek+(ING-ELEKTRONIKA)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
          ></iframe>
        </div>
      </div>
